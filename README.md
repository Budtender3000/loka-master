...
To enable an agent to discover and consume `loka-brain`, append the snippet from [`AGENTS.template.md`](AGENTS.template.md) to your project's root `AGENTS.md` (or `GEMINI.md` / `CODEX.md`):
